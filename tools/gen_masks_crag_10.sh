#!/bin/bash
# Generate masks and/or scores. Supports UNI + sliding_window.
# Usage: bash tools/gen_masks_crag_10.sh <checkpoint_path> [split] [out_dir] [mode] [port]
#   mode: score | mask | both (default).
# Example: .../gen_masks_crag_10.sh exp/crag/10/corrmatch/best.pth test visual score
...
echo "Config: configs/crag_10.yaml"
